...
const translations = {
    es: {
        ...
        hero_btn_register: "Crear Cuenta Gratis",
        ...
        conv10_title: "Becas Nacionales para Estudios de Posgrado 2026",
        conv10_desc: "Becas de SECIHTI para estudios de maestría y doctorado en universidades nacionales. Incluye manutención, colegiatura y apoyos complementarios de movilidad para investigadores en formación.",
        conv10_req: "Ser mexicano, estar inscrito en programa de posgrado en universidad nacional, promedio mínimo de 8.0, no contar con otra beca gubernamental para el mismo nivel.",
        conv11_title: "Becas Nacionales de Inclusión 2026",
        conv11_desc: "Programa de SECIHTI que ofrece becas de licenciatura para jefas de familia y apoyos complementarios para personas indígenas y con discapacidad que cursan posgrados nacionales.",
        conv11_req: "Línea A: ser jefa de familia mexicana cursando licenciatura. Líneas B y C: ser beneficiario vigente de beca SECIHTI de posgrado nacional y ser indígena o persona con discapacidad.",
        conv12_title: "Apoyos Complementarios de Movilidad 2026",
        conv12_desc: "SECIHTI ofrece apoyos de movilidad internacional, nacional, en sectores de interés y para programas de doble titulación a beneficiarios de becas nacionales vigentes.",
        conv12_req: "Ser beneficiario vigente de beca nacional SECIHTI, carta de aceptación de institución destino, plan de estancia aprobado por tutor.",
        conv13_title: "Becas de Especialidades Médicas Nacionales 2026",
        conv13_desc: "SECIHTI ofrece becas de posgrado y apoyos complementarios de movilidad para médicos mexicanos que cursen especialidades médicas en instituciones nacionales de salud.",
        conv13_req: "Título de médico cirujano, estar inscrito en programa de especialidad médica nacional, promedio mínimo de 8.0, servicio social completado.",
        conv14_title: "Becas para la Formación en Centros Públicos SECIHTI 2026",
        conv14_desc: "Programa de becas de SECIHTI para formación de investigadores en centros públicos de investigación adscritos a la Secretaría. Cubre manutención y colegiatura.",
        conv14_req: "Ser mexicano, estar inscrito en programa de formación en centro público SECIHTI, cumplir requisitos del nivel inmediato anterior.",
        conv15_title: "Apoyo Complementario de Maternidad y Paternidad 2026",
        conv15_desc: "SECIHTI ofrece apoyo económico complementario a beneficiarios de becas nacionales de posgrado durante su periodo de maternidad o paternidad.",
        conv15_req: "Ser beneficiario vigente de beca nacional de posgrado SECIHTI, presentar acta de nacimiento del hijo, tramitar dentro del periodo correspondiente."
    },
    en: {
        // Nav
        nav_inicio: "Home",
        ...
        hero_btn_register: "Create Free Account",
        ...
        conv10_title: "National Postgraduate Scholarships 2026",
        conv10_desc: "SECIHTI scholarships for master's and doctoral studies at national universities. Includes living expenses, tuition, and complementary mobility support for researchers in training.",
        conv10_req: "Mexican national, enrolled in a postgraduate program at a national university, minimum GPA of 8.0, no other government scholarship at the same level.",
        conv11_title: "National Inclusion Scholarships 2026",
        conv11_desc: "SECIHTI program offering undergraduate scholarships for female heads of household and complementary support for Indigenous persons and persons with disabilities pursuing national postgraduate studies.",
        conv11_req: "Line A: Mexican female head of household pursuing undergraduate studies. Lines B & C: current SECIHTI national postgraduate scholarship holder who is Indigenous or a person with a disability.",
        conv12_title: "Complementary Mobility Support 2026",
        conv12_desc: "SECIHTI offers international, domestic, priority-sector, and double-degree mobility support to current national scholarship holders.",
        conv12_req: "Current SECIHTI national scholarship holder, acceptance letter from destination institution, tutor-approved stay plan.",
        conv13_title: "National Medical Specialties Scholarships 2026",
        conv13_desc: "SECIHTI offers postgraduate scholarships and complementary mobility support for Mexican physicians pursuing medical specialties at national health institutions.",
        conv13_req: "Medical degree, enrolled in a national specialty program, minimum GPA of 8.0, completed social service.",
        conv14_title: "Training Scholarships at SECIHTI Public Centers 2026",
        conv14_desc: "SECIHTI scholarship program for training researchers at public research centers under the Secretariat. Covers living expenses and tuition.",
        conv14_req: "Mexican national, enrolled in a training program at a SECIHTI public center, meet prior-level requirements.",
        conv15_title: "Maternity and Paternity Complementary Support 2026",
        conv15_desc: "SECIHTI offers complementary financial support to national postgraduate scholarship holders during maternity or paternity leave.",
        conv15_req: "Current SECIHTI national postgraduate scholarship holder, present child's birth certificate, apply within the corresponding period."
    }
};
...
const convocatorias = [
    ...
    },
    {
        ...
        sourceName: "SECIHTI",
        status: "cerrada",
        statusLabel: { es: "Cerrada", en: "Closed" },
    ...
    },
    {
        ...
        catLabel: { es: "Educación", en: "Education" },
        catClass: "cat-educacion",
        titleKey: "conv10_title",
        descKey: "conv10_desc",
        reqKey: "conv10_req",
        amount: { es: "Beca de posgrado", en: "Postgraduate scholarship" },
        deadline: "2026-11-28",
        region: { es: "México (Nacional)", en: "Mexico (National)" },
        sourceUrl: "https://secihti.mx/convocatoria/becas-nacionales/convocatoria-de-becas-nacionales-para-estudios-de-posgrado-2026/",
        sourceName: "SECIHTI",
        status: "abierta",
        statusLabel: { es: "Abierta", en: "Open" },
        icon: "fas fa-graduation-cap"
    },
    {
        ...
        catClass: "cat-social",
        titleKey: "conv11_title",
        descKey: "conv11_desc",
        reqKey: "conv11_req",
        amount: { es: "Beca + apoyo complementario", en: "Scholarship + complementary support" },
        deadline: "2026-09-25",
        region: { es: "México (Nacional)", en: "Mexico (National)" },
        sourceUrl: "https://secihti.mx/convocatoria/becas-nacionales/convocatoria-becas-nacionales-de-inclusion-2026/",
        sourceName: "SECIHTI",
        status: "abierta",
        statusLabel: { es: "Abierta", en: "Open" },
    ...
    },
    {
        ...
        catLabel: { es: "Educación", en: "Education" },
        catClass: "cat-educacion",
        titleKey: "conv12_title",
        descKey: "conv12_desc",
        reqKey: "conv12_req",
        amount: { es: "Apoyo de movilidad", en: "Mobility support" },
        deadline: "2026-10-31",
        region: { es: "Nacional e Internacional", en: "National & International" },
        sourceUrl: "https://secihti.mx/convocatoria/becas-nacionales/convocatoria-de-apoyos-complementarios-de-movilidad-en-el-extranjero-movilidad-nacional-movilidad-en-los-sectores-de-interes-y-movilidad-para-programas-de-doble-titulacion-2026/",
        sourceName: "SECIHTI",
        status: "abierta",
        statusLabel: { es: "Abierta", en: "Open" },
    ...
    },
    {
        ...
        catLabel: { es: "Salud", en: "Health" },
        catClass: "cat-salud",
        titleKey: "conv13_title",
        descKey: "conv13_desc",
        reqKey: "conv13_req",
        amount: { es: "Beca + movilidad", en: "Scholarship + mobility" },
        deadline: "2026-11-28",
        region: { es: "México (Nacional)", en: "Mexico (National)" },
        sourceUrl: "https://secihti.mx/convocatoria/becas-nacionales/convocatoria-de-becas-de-posgrado-y-apoyos-complementarios-de-movilidad-para-especialidades-medicas-nacionales-2026/",
        sourceName: "SECIHTI",
        status: "abierta",
        statusLabel: { es: "Abierta", en: "Open" },
        icon: "fas fa-user-md"
    },
    {
        ...
        catLabel: { es: "Educación", en: "Education" },
        catClass: "cat-educacion",
        titleKey: "conv14_title",
        descKey: "conv14_desc",
        reqKey: "conv14_req",
        amount: { es: "Beca de formación", en: "Training scholarship" },
        deadline: "2026-10-23",
        region: { es: "México (Nacional)", en: "Mexico (National)" },
        sourceUrl: "https://secihti.mx/convocatoria/becas-nacionales/convocatoria-becas-nacionales-para-la-formacion-en-cp-secihti-2026/",
        sourceName: "SECIHTI",
        status: "abierta",
        statusLabel: { es: "Abierta", en: "Open" },
    ...
    },
    {
        ...
        catLabel: { es: "Desarrollo Social", en: "Social Development" },
        catClass: "cat-social",
        titleKey: "conv15_title",
        descKey: "conv15_desc",
        reqKey: "conv15_req",
        amount: { es: "Apoyo complementario", en: "Complementary support" },
        deadline: "2026-12-03",
        region: { es: "México (Nacional)", en: "Mexico (National)" },
        sourceUrl: "https://secihti.mx/convocatoria/becas-nacionales/convocatoria-2026-apoyo-complementario-de-maternidad-y-paternidad-nacional-en-el-extranjero-y-de-consolidacion/",
        sourceName: "SECIHTI",
        status: "abierta",
        statusLabel: { es: "Abierta", en: "Open" },
        icon: "fas fa-baby"
